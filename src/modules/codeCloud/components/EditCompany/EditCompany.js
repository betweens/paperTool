...
class EditCompany extends PageManager {
  constructor(props){
    super(props)
    this.state = {
      isDataReady: true,
...
{/*      <section className="flex-hrz">
      ...
      <div className="container">
        ...
        <div className="flex-init file-btn"  onClick={this.upgradeProfile.bind(this)}><i className="iconfont icon-shangchuan1"></i><span>Save</span></div>
